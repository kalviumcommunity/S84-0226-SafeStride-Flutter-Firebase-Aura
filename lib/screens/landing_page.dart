...
class _LandingPageState extends State<LandingPage>
  ...
  Widget _buildTrustBadge() {
    return Row(
      children: [
        _starRow(5),
        const SizedBox(width: 10),
        const Text('10,000+ safe striders',
            style: TextStyle(
                color: _kGrey,
                fontSize: 13,
                fontWeight: FontWeight.w500)),
      ...
      child: SlideTransition(
        position: Tween<Offset>(
            ...
            .animate(CurvedAnimation(
                parent: _heroAnim, curve: Curves.easeOut)),
        child: Center(
          child: Container(
  ...
  Widget _safeChip(IconData icon, String label) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(50),
          border:
              Border.all(color: const Color(0xFFE4E9F2), width: 1),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            LayoutBuilder(builder: (context, constraints) {
              ...
              final steps = [
                _StepCard(
                    ...
                    icon: '🏃',
                    title: 'Choose Mode',
                    body: 'Pick Runner or Cyclist — we tailor routes to your pace.'),
                _StepCard(
                    number: '02',
                    icon: '🗺️',
                    title: 'Discover Safe Routes',
                    body: 'Browse routes scored by lighting, traffic & crowd levels.'),
                _StepCard(
                    number: '03',
                    icon: '🛡️',
                    title: 'Track & Stay Safe',
                    body: 'Follow your route with live safety alerts along the way.'),
              ];
              if (isMobile) {
                return Column(
                  children: steps
                      .map((s) => Padding(
                          padding: const EdgeInsets.only(bottom: 16), child: s))
                      .toList(),
                );
              }
              return Row(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _starRow(5),
                  const SizedBox(width: 10),
                  const Text('Trusted by 10,000+ active users',
                      style: TextStyle(
                          fontWeight: FontWeight.w700,
                          color: _kDark,
                          fontSize: 15)),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const Text('© 2026 Safe Stride. All rights reserved.',
...
class _MapLinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width * 0.65, 0),
        Offset(size.width * 0.65, size.height), road);
    canvas.drawLine(Offset(0, size.height * 0.65),
        Offset(size.width, size.height * 0.65), road);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(body,
              style: const TextStyle(
                  fontSize: 13, color: _kGrey, height: 1.6)),
        ],
      ),
    );
  }
